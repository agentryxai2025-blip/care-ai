...
import { Search, FileText, List, LayoutGrid, ChevronRight, Plus } from "lucide-react";
...
const requests = [
  { id: "REQ-2847", participant: "Margaret Chen", service: "Personal Care", urgency: "Priority", location: "Newtown NSW 2042", schedule: "Daily 8-10am", status: "Matching", created: "2 May 2026", provider: null },
  { id: "REQ-2846", participant: "David Okonkwo", service: "Community Access", urgency: "Routine", location: "Surry Hills NSW 2010", schedule: "Wed 10am-2pm", status: "Booked", created: "1 May 2026", provider: "James O'Brien" },
  { id: "REQ-2845", participant: "Sarah Williams", service: "Therapy Support", urgency: "Emergency", location: "Bondi NSW 2026", schedule: "ASAP", status: "Pending Match", created: "1 May 2026", provider: null },
  { id: "REQ-2844", participant: "James Patel", service: "Domestic Assistance", urgency: "Routine", location: "Parramatta NSW 2150", schedule: "Fortnightly Sat 9am", status: "Completed", created: "30 Apr 2026", provider: "Carlos Mendez" },
  { id: "REQ-2843", participant: "Aisha Nguyen", service: "Personal Care", urgency: "Priority", location: "Cabramatta NSW 2166", schedule: "Daily 7-8:30am", status: "Matched", created: "30 Apr 2026", provider: "Fatima Al-Hassan" },
  { id: "REQ-2842", participant: "Tom Eriksen", service: "Personal Care", urgency: "Routine", location: "Manly NSW 2095", schedule: "Mon/Wed/Fri 9-11am", status: "Booked", created: "29 Apr 2026", provider: "Maria Santos" },
  { id: "REQ-2841", participant: "Linda Zhao", service: "Community Access", urgency: "Routine", location: "Chatswood NSW 2067", schedule: "Thu 1-4pm", status: "Completed", created: "29 Apr 2026", provider: "Wei Zhang" },
  { id: "REQ-2840", participant: "Robert Kirby", service: "Behaviour Support", urgency: "Priority", location: "Liverpool NSW 2170", schedule: "Weekly Tue 2-4pm", status: "Booked", created: "28 Apr 2026", provider: "Thomas Nkosi" },
  { id: "REQ-2839", participant: "Yuki Tanaka", service: "Personal Care", urgency: "Routine", location: "Strathfield NSW 2135", schedule: "Daily 8-9am", status: "Completed", created: "28 Apr 2026", provider: "Sophie Laurent" },
  { id: "REQ-2838", participant: "Carlos Rivera", service: "Community Access", urgency: "Routine", location: "Fairfield NSW 2165", schedule: "Fortnightly Fri 10am-12pm", status: "Booked", created: "27 Apr 2026", provider: "Isabella Cruz" },
  { id: "REQ-2837", participant: "Grace O'Sullivan", service: "Domestic Assistance", urgency: "Routine", location: "Cronulla NSW 2230", schedule: "Weekly Mon 10am-12pm", status: "Cancelled", created: "27 Apr 2026", provider: null },
  { id: "REQ-2836", participant: "Ahmed Hassan", service: "Personal Care", urgency: "Priority", location: "Auburn NSW 2144", schedule: "Daily 7:30-9am", status: "Intake", created: "26 Apr 2026", provider: null },
  { id: "REQ-2835", participant: "Margaret Chen", service: "Therapy Support", urgency: "Routine", location: "Newtown NSW 2042", schedule: "Fortnightly Thu 11am-1pm", status: "Completed", created: "25 Apr 2026", provider: "Priya Sharma" },
  { id: "REQ-2834", participant: "David Okonkwo", service: "Social Support", urgency: "Routine", location: "Surry Hills NSW 2010", schedule: "Weekly Fri 2-4pm", status: "Booked", created: "24 Apr 2026", provider: "Amara Diallo" },
  { id: "REQ-2833", participant: "James Patel", service: "Community Access", urgency: "Routine", location: "Parramatta NSW 2150", schedule: "Monthly 1st Sat 9am-1pm", status: "Completed", created: "23 Apr 2026", provider: "James O'Brien" },
  { id: "REQ-2832", participant: "Aisha Nguyen", service: "Therapy Support", urgency: "Priority", location: "Cabramatta NSW 2166", schedule: "Weekly Wed 10am-12pm", status: "Completed", created: "22 Apr 2026", provider: "Priya Sharma" },
  { id: "REQ-2831", participant: "Tom Eriksen", service: "Personal Care", urgency: "Routine", location: "Manly NSW 2095", schedule: "Daily 9-11am", status: "Completed", created: "21 Apr 2026", provider: "Maria Santos" },
  { id: "REQ-2830", participant: "Robert Kirby", service: "Domestic Assistance", urgency: "Routine", location: "Liverpool NSW 2170", schedule: "Weekly Sat 9-11am", status: "Validated", created: "20 Apr 2026", provider: null },
  { id: "REQ-2829", participant: "Linda Zhao", service: "Personal Care", urgency: "Emergency", location: "Chatswood NSW 2067", schedule: "ASAP", status: "Completed", created: "19 Apr 2026", provider: "Wei Zhang" },
  { id: "REQ-2828", participant: "Carlos Rivera", service: "Behaviour Support", urgency: "Priority", location: "Fairfield NSW 2165", schedule: "Weekly Tue/Thu 3-5pm", status: "Booked", created: "18 Apr 2026", provider: "Thomas Nkosi" },
];
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button size="sm" data-testid="btn-new-request">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                {filtered.map((r) => (
                  <tr key={r.id} className="hover:bg-muted/30 transition-colors" data-testid={`request-row-${r.id}`}>
